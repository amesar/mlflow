...
>>>>>>> 72eb7fddd525ae865ad6da85820bd8eaa9874288
...
MLflow Java client uses [Protobuf](https://developers.google.com/protocol-buffers/) to serialize its JSON payload.
...
* Javadoc can be generated by running ``mvn javadoc:javadoc``. The output will be in [target/site/apidocs/index.html](target/site/apidocs/index.html). Here you can find the javadoc for [Service.java](target/site/apidocs/com/databricks/api/proto/mlflow/Service.html).
=======
